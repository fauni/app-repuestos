...
export class Convert {
    public static toMovimiento(json: string): Movimiento {
        return cast(JSON.parse(json), r("Movimiento"));
    }

    public static movimientoToJson(value: Movimiento): string {
        return JSON.stringify(uncast(value, r("Movimiento")), null, 2);
    }
}
...
const typeMap: any = {
    "Movimiento": o([
        ...
        { json: "almacen", js: "almacen", typ: r("Almacen") },
        { json: "valor", js: "valor", typ: 0 },
        { json: "precio", js: "precio", typ: "" },
        { json: "descripcion", js: "descripcion", typ: "" },
        { json: "tipo_movimiento", js: "tipo_movimiento", typ: r("TipoMovimiento") },
    ], false),
    "Almacen": o([
        { json: "id", js: "id", typ: 0 },
        { json: "nombre", js: "nombre", typ: "" },
        { json: "descripcion", js: "descripcion", typ: "" },
        { json: "lugar", js: "lugar", typ: "" },
        { json: "direccion", js: "direccion", typ: "" },
        { json: "estado", js: "estado", typ: r("TipoMovimiento") },
    ], false),
    "TipoMovimiento": o([
        { json: "id", js: "id", typ: 0 },
        { json: "created", js: "created", typ: Date },
        { json: "modified", js: "modified", typ: Date },
        { json: "estado", js: "estado", typ: u(undefined, "") },
